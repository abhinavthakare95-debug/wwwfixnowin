    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Get help in minutes, not hours</p>
        </div>

        <form onSubmit={handleSignup} className="bg-card border border-border/50 rounded-xl p-6 space-y-4">
          <div>
